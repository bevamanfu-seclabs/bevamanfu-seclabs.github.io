...
![Splunk results showing suspicious requests]({{ '/assets/projects/DA/drone-alone-1.png' | relative_url }})
...
![Splunk results showing suspicious requests]({{ '/assets/projects/DA/drone-alone-decoded.png' | relative_url }})
...
![Splunk results showing suspicious requests]({{ '/assets/projects/DA/drone-alone-query2.png' | relative_url }})
...
![Splunk results showing suspicious requests]({{ '/assets/projects/DA/drone-alone-query4.png' | relative_url }})
...
![Splunk results showing suspicious requests]({{ '/assets/projects/DA/drone-alone-query5.png' | relative_url }})
